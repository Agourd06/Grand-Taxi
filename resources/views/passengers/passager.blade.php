...
<body>
    ...
    <div>
        ...
        <section class="flex min-h-screen mt-8 flex-col  md:flex-row">
            <!-------------------------------------------------------------Filter------------------------------------------------- -->
            <div class="md:w-[19%] md:ml-auto mb-8 md:mb-0 flex flex-col items-center">
                {{-- filter by Traji --}}
                ...
                <form id="filterForm" action="/filter" method="POST" class="mb-8">
                    ...
                    <div class="flex gap-8">
                        <select id="filterSelect" name="filtertrip"
                            class="border-0 cursor-pointer rounded-full outline-none  drop-shadow-md bg-black text-white hover:text-black w-60 md:w-40 duration-300 hover:bg-[#EACE00] ">
                ...
                <form id="filterForm" action="/filter" method="POST">
                    ...
                    <label for="filterSelect">Select Trip:</label>
                    <div class="flex gap-8">

                        <select id="filterSelect" name="filterCars"
                            class="border-0 cursor-pointer rounded-full px-4 outline-none drop-shadow-md bg-black  text-white hover:text-black w-60 md:w-40 duration-300 hover:bg-[#EACE00] ">
                            @foreach ($filtarge as $filtarg)
                ...
                <div class="flex flex-wrap items-center justify-between">
                    <div class="w-full md:w-auto  mb-6 md:mb-0">
                        <a href="../" class=" w-full flex justify-center md:justify-start"><img
                                ...
                                src="../../../public/images/logowiki.png" alt="WIKI Logo" /></a>
                    </div>
                    <div class="w-full md:w-auto text-center">
                        <ul class="flex items-center justify-center flex-wrap gap-y-2 md:justify-end space-x-6">
                            <li><a href="../" class="text-gray-700 hover:text-gray-900 text-base">Home</a></li>
                            <li><a href="../visiteur/wikis.php"
                                    class="text-gray-700 hover:text-gray-900 text-base">Wikis</a></li>


                            <li><a href="../authentification/login.php"
